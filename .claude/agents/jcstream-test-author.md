...
- The current test layout (15 files, ≥173 collected tests as of 2026-05-14, no `conftest.py` yet)
...
Run `python -m pytest -q` and confirm `≥173 passed`. When adding a fixture used by 2+ test files, create `tests/conftest.py`.
