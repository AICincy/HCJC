...
## A. Drift
- `web/build.py:79-140` cited as the registration range; actual block runs `web/build.py:109-184` post-2026-05-19 refactor (line 184 registers `all_inmates_total`). The SKILL.md cite is pre-refactor.
